...
## POWER QUERY
*  use M-language, the development language that is used to build queries in Power Query, to define a common date table.

![Screenshot 2024-06-25 101538](https://github.com/BafanaMadume/POWERBI/assets/141032267/fa834e6b-476a-4f3d-8a50-cdfa1b9fad4e)


![Screenshot 2024-06-25 102507](https://github.com/BafanaMadume/POWERBI/assets/141032267/6f8d959c-2a72-4a31-a1da-d0681865d2f6)

* After you have finished selecting the Date type, you can add columns for year, months, weeks, and days. Go to Add Column, select the drop-down menu under Date, and then select Year,

## MARK AS THE OFFICIAL DATE TABLE
* First task in marking your table as the official date table is to find the new table on the Fields pane. Right-click the name of the table and then select Mark as date table.
* marking your table as a date table, Power BI performs validations to ensure that the data contains zero null values, is unique, and contains continuous date values over a period.
* Right-click the table, select Mark as date table, and then select Date table settings
